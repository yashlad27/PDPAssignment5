...
public class CopyCommandParser extends AbstractCommandParser {
    public CopyCommandParser(ICommandFactory commandFactory) {
    ...
    public CommandParser.CommandWithArgs parseCommand(String commandString) {
        ...
        return new CommandParser.CommandWithArgs(commandFactory.getCommand("copy"), new String[]{eventName});
    }
}
